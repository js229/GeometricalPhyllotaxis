...
lowest  = nextCoinAndContacts[n,chainNumbers,r,run];
];
If[!MissingQ[lowest],
...
{highestCoinZ,k,phi,parastichyTop,nodeAssociation},
...
If[highestCoinZ+ 2 arenaAssociation["rFunction"][highestCoinZ]> (arenaAssociation["cylinderLU"])[[2]],Break[]];
],
