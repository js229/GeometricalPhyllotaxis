...
"StemBulge",glatticeBulgeRegion[lattice]
]
];
...
region1= DiscretizeRegion@Region@ParametricRegion[bfunc[{cylinder\[LeftDoubleBracket]1,2\[RightDoubleBracket],z}],{{z,cylinder\[LeftDoubleBracket]2,1\[RightDoubleBracket],cylinder\[LeftDoubleBracket]2,2\[RightDoubleBracket]}}];
points1 = MeshPrimitives[region1,0];
points2 = Map[ReflectionTransform[{1,0}],Reverse@points1];
Polygon@Join[points1,points2]/. Point[x_]-> x 
*)
cylinder= latticeGetCylinder[lattice];
bfunc = latticeScaling[lattice,"StemBulge"];
region = DiscretizeRegion@Region@ParametricRegion[bfunc[{x,z}],{{x,cylinder[[1,1]],cylinder[[1,2]]},{z,cylinder[[2,1]],cylinder[[2,2]]}}];
