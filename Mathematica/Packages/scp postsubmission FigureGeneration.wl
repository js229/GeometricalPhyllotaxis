...
Get["DiskStacking`",Path->FileNameJoin[PersistentSymbol["persistentGitHubPath"],"GeometricalPhyllotaxis\\Mathematica\\Packages"]];
Get["scpPaperStylings.m",Path->NotebookDirectory[]];
