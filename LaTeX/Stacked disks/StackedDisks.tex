...
%
\pdffig{scpConeTransformation}{Mapping  organ placement to a disk pattern.  Node positions below the rim, shown in black, are assumed to have been formed during development , but are largely not observed in mature sunflowers; bracts are modelled as green nodes on the rim, and then ray florets and seed-setting flower positions are  modelled as yellow and then brown nodes on the top surface of the cone. }{1}
%
