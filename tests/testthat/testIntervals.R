...
test_that("generating intervals work", {
...
test_that("opposed intervals work", {
  oiList <- divergenceInterval (m=4,n=5,Delta=1,scale="unity",type="opposed")
  oi <- oiList[3,]
  dinoi <- oi[1]+ 0.6*(oi[2]-oi[1])

  expect_equal(GeometricalPhyllotaxis:::isOpposed(4,5,dinoi,scale="unity"),TRUE)
