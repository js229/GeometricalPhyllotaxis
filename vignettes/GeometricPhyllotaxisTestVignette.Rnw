...
gix <- list (c(1,1),c(1,2),c(1,3),c(1,4),c(1,5),
	...
	c(3,4),c(3,5),c(3,7),c(3,8),c(3,10),
	c(4,5),c(4,7),c(4,9),
...
@
\caption{Generating intervals for a range of parastichy pairs. Light grey: $\Delta=+1$;
Dark grey: $\Delta=-1$. Pink: subinterval on which pair is opposed.}
\label{fig:ogi}
\end{figure}
\end{center}
